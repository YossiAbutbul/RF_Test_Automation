    ...
    <Card className='p-4'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
        <div>
          ...
          <select className='field w-full mt-1'><option>IoT Sensor Array Project</option></select>
        </div>
        <div>
          <label className='text-xs text-zinc-500'>Select DUT (MAC Address)</label>
          <select className='field w-full mt-1'><option>AA:BB:CC:DD:EE:FF (RF_Device_001)</option></select>
        </div>
      </div>
